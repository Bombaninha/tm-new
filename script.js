...
const iconNotification = notification.querySelector('.icon');
const dropdownNotification = notification.querySelector('.notification-link');
...
window.addEventListener('load', function(e) {
	const menuIsCollapsed = localStorage.getItem('menuCollapse');

	if(menuIsCollapsed === 'true') {
		sidebar.classList.add('hide');
	}

	console.log(menuIsCollapsed);
})